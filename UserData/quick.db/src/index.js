...
var methods = {
    ...
    multiply: require("./methods/multiply.js"),
    divide: require("./methods/divide.js"),
    modulus: require("./methods/modulus.js"),
...
module.exports = {
    ...
    multiply: function (key, value, ops) {
        if (!key)
            throw new TypeError(
                "No field specified."
            );
       
        return arbitrate("multiply", { id: key, data: value, ops: ops || {} });
    },

    divide: function (key, value, ops) {
        if (!key)
            throw new TypeError(
                "No field specified."
            );
       
        return arbitrate("divide", { id: key, data: value, ops: ops || {} });
    },

    modulus: function (key, value, ops) {
        if (!key)
            throw new TypeError(
                "No field specified."
            );
       
        return arbitrate("modulus", { id: key, data: value, ops: ops || {} });
    },
...
function arbitrate(method, params, tableName) {
    ...
    if (params.stringify) {
        try {
            params.data = JSON.stringify(params.data, (_, v) => typeof v === 'bigint' ? v.toString() : v)
        } catch (e) {
            throw new TypeError(
